...
export default function SpinLogo() {
  return (
    <div className='flex justify-center items-center overflow-hidden fixed right-4 bottom-4 z-10 mini-tablet:right-8 mini-tablet:left-auto mini-tablet:top-0 mini-tablet:bottom-auto mini-tablet:absolute mobile:right-0'>
